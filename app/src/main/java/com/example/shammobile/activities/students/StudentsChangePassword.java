...
public class StudentsChangePassword extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.students_changepassword);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(StudentsChangePassword.this, TeachersProfileActivity.class).putExtras(bundle));
            }
        });
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(newpassword.getText().toString()) || TextUtils.isEmpty(cnewpassword.getText().toString())){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(StudentsChangePassword.this);
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Toast.makeText(StudentsChangePassword.this, "Saving...", Toast.LENGTH_LONG).show();
                            ...
                            Call<ChangePassword> call = APIUtils.getUserService().editStudentpassword(studentID, a);
                            call.enqueue(new Callback<ChangePassword>() {
                                @Override
                                public void onResponse(Call<ChangePassword> call, Response<ChangePassword> response) {
                                    if (response.isSuccessful()) {
                                        Toast.makeText(StudentsChangePassword.this, "Password Changed Successfully", Toast.LENGTH_LONG).show();
                                        startActivity(new Intent(StudentsChangePassword.this, StudentsProfileActivity.class).putExtras(bundle));
                                    }
                                    else{
                                        Toast.makeText(StudentsChangePassword.this, "Check Current Password", Toast.LENGTH_LONG).show();
                                    }
                                }
                                ...
                                public void onFailure(Call<ChangePassword> call, Throwable t) {
                                    ...
                                    Toast.makeText(StudentsChangePassword.this, "Check Internet Connection or Restart the App", Toast.LENGTH_LONG).show();
                                }
                            });
