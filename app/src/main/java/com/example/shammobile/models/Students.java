...
public class Students {
    ...
    public Students(List<Students> data, String id, String fname, String mname, String lname,
                    String extname, String age, String birthdate, String gender, String contact,
                    String mothertongue, String religion, String housestreet, String barangay,
                    String city, String province, String region, String indipeople,
                    String specialneeds, String assistivedevices, String mothername,
                    String mothereducation, String motheremployment, String motherworkstat,
                    String mothercontact, String fathername, String fathereducation,
                    String fatheremployment, String fatherworkstat, String fathercontact,
                    String guardianname, String guardianeducation, String guardianemployment,
                    String guardianworkstat, String guardiancontact, String strandID,
                    String sectionID, String status, String lrn, String psa, String email,
                    String image, String attendance) {
        this.data = data;
        this.id = id;
        this.fname = fname;
        this.mname = mname;
